...
public class adapter_post_spot extends RecyclerView.Adapter<adapter_post_spot.CustomViewHolder> {
    ...
    public adapter_post_spot(ArrayList<item_record_spot_list_pic_comment> list) {
        this.mList = list;
    }

    @Override
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_post_spot_pic_comment, viewGroup, false);
